...
\KeywordTok{plot}\NormalTok{(f, }\DataTypeTok{edge.label =} \KeywordTok{round}\NormalTok{(}\KeywordTok{E}\NormalTok{(f)}\OperatorTok{$}\NormalTok{prob, }\DecValTok{2}\NormalTok{),}\DataTypeTok{vertex.size=}\DecValTok{30}\NormalTok{, }\DataTypeTok{edge.arrow.size =} \FloatTok{.25}\NormalTok{, }\DataTypeTok{edge.curved=}\FloatTok{0.3}\NormalTok{, }\DataTypeTok{edge.label.cex =} \FloatTok{.5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
